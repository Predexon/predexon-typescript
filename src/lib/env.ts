...
export interface Env {
  PREDEXON_DATA_API_KEY?: string | undefined;
  PREDEXON_TRADING_API_KEY?: string | undefined;

  PREDEXON_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  PREDEXON_DATA_API_KEY: z.optional(z.string()),
  PREDEXON_TRADING_API_KEY: z.optional(z.string()),

  PREDEXON_DEBUG: z.optional(z.coerce.boolean()),
});
