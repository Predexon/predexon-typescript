...
```typescript
import { PolymarketListEventsRequest } from "@predexon/sdk/models/operations";

let value: PolymarketListEventsRequest = {};
```
...
| `paginationKey`                                                               | *string*                                                                      | :heavy_minus_sign:                                                            | Cursor for the next page (from previous response's pagination.pagination_key) |